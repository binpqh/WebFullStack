...
{
    public partial class team1version001 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK__staffs__manager___440B1D61",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__stocks__E68284D3035ABD29", x => new { x.store_id, x.product_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__order_it__837942D4485B1307", x => new { x.order_id, x.item_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__staffs__AB6E61642445860B",
                schema: "sales",
                table: "staffs",
                column: "email",
                unique: true);
